      ...
      <Section className="pt-4 pb-16">
        <div className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-2xl border border-brand-100 bg-brand-50 p-6 shadow-card">
            ...
            <p className="mt-3 text-sm leading-relaxed text-brand-900/80">{aboutContent.mission}</p>
          </article>
          <article className="rounded-2xl border border-brand-100 bg-brand-50 p-6 shadow-card">
            <h2 className="font-display text-2xl text-brand-900">Communities We Serve</h2>
            <p className="mt-3 text-sm leading-relaxed text-brand-900/80">{aboutContent.communitiesServed}</p>
          </article>
        </div>
